...
def calculate_ggh_vs_hb_mva(
    ...
    events_bdt["first_jet_wp"] = evaluate_ctag_wp(self.meta["HPC_ctag_WPs"]["wps"], events["first_jet_jet_pn_b_plus_c"], events["first_jet_jet_pn_b_vs_c"])
    events_bdt["second_jet_wp"] = evaluate_ctag_wp(self.meta["HPC_ctag_WPs"]["wps"], events["second_jet_jet_pn_b_plus_c"], events["second_jet_jet_pn_b_vs_c"])
    events_bdt["third_jet_wp"] = evaluate_ctag_wp(self.meta["HPC_ctag_WPs"]["wps"], events["third_jet_jet_pn_b_plus_c"], events["third_jet_jet_pn_b_vs_c"])
